...
fn criterion_benchmark_auto(c: &mut Criterion) {
    ...
    group.bench_function(
        ...
        |b| {
            ...
            b.iter(|| {
                ...
                // let mut glwe_output = GlweCiphertext::new(u64::ZERO, glwe_size, polynomial_size, ciphertext_modulus)
                ...
                let err = get_glwe_l2_err(&glwe_sk, &glwe, &plain);
                let err2 = get_glwe_max_err(&glwe_sk, &glwe, &plain);
                let err3 = get_glwe_avg_err(&glwe_sk, &glwe, &plain);
                l2_err.push(err);
                max_err.push(err2);
                avg_err.push(err3);
            });
    ...
    println!("[L2 Error of Original Trace function] {:.3} bits", ((l2_avg as f64)).log2());
    println!("[Maximum Error of Original Trace function] {:.3} bits", ((max_avg as f64)).log2());
    println!("[Average Error of Original Trace function] {:.3} bits", ((avg_avg as f64)).log2());
    ...
    println!("[L2 Error of RevHomTrace] {:.3} bits", ((l2_avg2 as f64)).log2());
    println!("[Maximum Error of RevHomTrace] {:.3} bits", ((max_avg2 as f64)).log2());
    println!("[Average Error of RevHomTrace] {:.3} bits", ((avg_avg2 as f64)).log2());
...
fn criterion_benchmark_high_prec_auto(c: &mut Criterion) {
    ...
    for (param, extract_size, id) in param_list.iter() {
        ...
        group.bench_function(
            ...
            |b| {
                ...
                b.iter(|| {
                    ...
                    let err = get_glwe_l2_err(&glwe_sk, &glwe_out, &plain);
                    let err2 = get_glwe_max_err(&glwe_sk, &glwe_out, &plain);
                    let err3 = get_glwe_avg_err(&glwe_sk, &glwe_out, &plain);
                    l2_err3.push(err);
                    max_err3.push(err2);
                    avg_err3.push(err3);
                });
        ...
        println!("[L2 Error of HP-Trace function] {:.3} bits", ((l2_avg3 as f64)).log2());
        println!("[Maximum Error of HP-Trace function] {:.3} bits", ((max_avg3 as f64)).log2());
        println!("[Average Error of HP-Trace function] {:.3} bits", ((avg_avg3 as f64)).log2());
    }
